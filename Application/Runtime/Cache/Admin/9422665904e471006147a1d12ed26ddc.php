...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-9">
				<?php if(!empty($comment)): if(is_array($comment)): foreach($comment as $key=>$vo): ?><div class="panel panel-default">
					
					<div class="panel-heading clearfix">
						<!-- <p class="panel-title"><?php echo ($title); ?></p> -->
						<p class="pull-left">评论者：<?php echo ($vo["comauthor"]); ?>&nbsp;评论时间：<?php echo ($vo["create_time"]); ?></p>
						<p class="pull-right" data-toggle="modal" data-target="#layer"><a class=" text-danger " href="javascript:;">删除</a></p>
						<p class="pull-right"><a href="<?php echo U('Admin/Comment/modify');?>?id=<?php echo ($vo["id"]); ?>">修改</a>&nbsp;</p>
					</div>
			...
			<script type="text/javascript">
				$('#del').click(function(){
					location.href='<?php echo U("Admin/Comment/delete");?>?id=<?php echo ($vo["id"]); ?>';
				});
			</script>				
		</div>
